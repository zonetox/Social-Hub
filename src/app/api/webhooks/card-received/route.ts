    ...
    try {
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; rounded: 12px;">
          ...
          <p style="font-size: 16px; color: #374151; line-height: 1.5;">
            <strong>${sender.full_name}</strong> (@${sender.username}) just sent you their digital profile card on <strong>Social HUB</strong>.
          </p>
          <p style="font-size: 16px; color: #374151; line-height: 1.5;">
          ...
          <div style="margin-top: 24px;">
            <a href="${profileUrl}" style="background-color: #4f46e5; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;">
              View ${profile.display_name}'s Profile
            </a>
          </div>
      ...
      `
            ...
            await sendEmail(receiver.email, `${sender.full_name} sent you their profile card! 🎉`, html)
        }
